...
// @generated from protobuf file "service/products/v1/product.proto" (package "service.products.v1", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message service.products.v1.Product
 */
...
class Product$Type extends MessageType<Product> {
    constructor() {
        super("service.products.v1.Product", [
    ...
    create(value?: PartialMessage<Product>): Product {
        const message = { id: "", name: "", description: "", imageId: "", price: "", currencyId: 0, rating: 0, categoryId: 0, specification: "", updatedAt: "", createdAt: "" };
...
/**
 * @generated MessageType for protobuf message service.products.v1.Product
 */
